...
class ColetoraEtapas:
    """Coleta e organiza etapas do cálculo para auditoria"""
    
    def __init__(self):
        self.etapas: list[EtapaCalculo] = []
        self.contador = 1
    ...
    def registrar(
        ...
        if DEBUG_COMISSIONAMENTO:
            print(f"[Etapa {etapa.numero}] {etapa.secao} → {etapa.descricao}")
    
    def obter_etapas(self) -> list[EtapaCalculo]:
        """Retorna todas as etapas coletadas"""
        return self.etapas
